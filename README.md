...
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:r.zain20041@gmail.com)
[![CGPA](https://img.shields.io/badge/CGPA-3.75%2F4.0-059669?style=for-the-badge&logo=graduation-cap&logoColor=white)](https://superior.edu.pk)
...
class RanaZainWaseem:
    ...
    def core_domains(self):
        return {
            "Agentic AI": ["CrewAI", "LangGraph", "Multi-Agent Workflows", "Autonomous Agents"],
            "Generative AI": ["Advanced RAG", "Prompt Tuning", "LLM APIs (OpenAI, Claude, Gemini)"],
            "Computer Vision": ["YOLOv8", "OpenCV", "Image Classification", "Object Detection"],
            "MLOps & Deployment": ["FastAPI", "Streamlit", "Docker", "Hugging Face Spaces"]
        }
...
```yaml
Hackathons:
  - Title: "Co-Creating with GPT-5 Hackathon"
    Host: "LabLab.AI"
    Status: "Completed & Project Showcased"
    Year: 2025

  - Title: "Anti-Short Video Addiction AI Hackathon"
    Host: "LabLab.AI"
    Status: "Completed"
    Year: 2025

  - Title: "Zero Limits Hackathon"
    Host: "Trae AI IDE"
    Status: "Completed"
    Year: 2025
...
Certifications:
  ...
  - "SQL Fundamentals" — SoloLearn (2025)
```
...
**"Building autonomous AI systems that augment human intelligence."**

<br/>

[![LinkedIn](https://img.shields.io/badge/Connect%20on-LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/rana-zain-694723254)
[![Portfolio](https://img.shields.io/badge/Explore-Portfolio%20Website-4F46E5?style=for-the-badge&logo=google-chrome&logoColor=white)](https://ranazain9.github.io/portfolio-/)
[![Email](https://img.shields.io/badge/Send-Direct%20Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:r.zain20041@gmail.com)
